...
#include <stdio.h>
#line 1 "as2transition/parser/lemon_parser.y"
...
#line 31 "as2transition/parser/lemon_parser.c"
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    13,   13,   12,   18,    6,   11,   11,   14,   17,   22,
 /*    10 */     5,   25,   19,    5,   16,    5,   10,    9,   20,    8,
 /*    20 */    20,    7,   20,    4,   15,    3,    2,   24,   41,    1,
 /*    30 */    21,   23,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     1,    1,    1,    2,    5,    6,    6,    8,    7,    4,
 /*    10 */     5,    0,    4,    5,    4,    5,    1,   15,   16,   15,
 /*    20 */    16,   15,   16,    3,   11,    3,    3,   14,   12,   13,
 /*    30 */    16,   14,
};
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    26,   40,   40,   40,   40,   40,   40,   40,   40,   40,
 /*    10 */    32,   40,   36,   30,   40,   29,   33,   39,   38,   37,
 /*    20 */    34,   35,   31,   28,   27,
};
...
static const char *const yyTokenName[] = { 
  ...
  "PAREN_R",       "COMMA",         "TILDE",         "STRING_LITERAL",
  "EOF",           "ERR_UNKNOWN_SYMBOL",  "ERR_UNTERMINATED_STRING",  "error",       
  "solution",      "pred_list",     "predicate",     "obj_list",    
  "object",      
};
//#endif /* NDEBUG */
...
static void yy_destructor(
  ...
  switch( yymajor ){
    ...
    */
    ...
    case 8: /* EOF */
    case 9: /* ERR_UNKNOWN_SYMBOL */
    case 10: /* ERR_UNTERMINATED_STRING */
{
#line 45 "as2transition/parser/lemon_parser.y"
 DEALLOC((yypminor->yy0));								
#line 424 "as2transition/parser/lemon_parser.c"
}
      break;
    case 12: /* solution */
    case 13: /* pred_list */
{
#line 56 "as2transition/parser/lemon_parser.y"
 /* Intentionally left blank */			
#line 432 "as2transition/parser/lemon_parser.c"
}
      break;
    case 14: /* predicate */
{
#line 60 "as2transition/parser/lemon_parser.y"
 DEALLOC((yypminor->yy20));								
#line 439 "as2transition/parser/lemon_parser.c"
}
      break;
    case 15: /* obj_list */
{
#line 62 "as2transition/parser/lemon_parser.y"
 DEALLOC((yypminor->yy18));								
#line 446 "as2transition/parser/lemon_parser.c"
}
      break;
    case 16: /* object */
{
#line 64 "as2transition/parser/lemon_parser.y"
 DEALLOC((yypminor->yy2));								
#line 453 "as2transition/parser/lemon_parser.c"
}
      break;
...
static void yy_reduce(
  ...
  **     break;
  */
      case 0: /* solution ::= pred_list EOF */
#line 66 "as2transition/parser/lemon_parser.y"
{
  yy_destructor(yypParser,8,&yymsp[0].minor);
}
#line 773 "as2transition/parser/lemon_parser.c"
        break;
      case 2: /* pred_list ::= pred_list predicate */
#line 68 "as2transition/parser/lemon_parser.y"
{ parser->_add(yymsp[0].minor.yy20); }
#line 778 "as2transition/parser/lemon_parser.c"
        break;
      case 3: /* pred_list ::= pred_list COMMA predicate */
#line 69 "as2transition/parser/lemon_parser.y"
{ parser->_add(yymsp[0].minor.yy20);   yy_destructor(yypParser,5,&yymsp[-1].minor);
}
#line 784 "as2transition/parser/lemon_parser.c"
        break;
      case 5: /* predicate ::= IDENTIFIER */
#line 73 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy20 = new Predicate(yymsp[0].minor.yy0); }
#line 789 "as2transition/parser/lemon_parser.c"
        break;
      case 6: /* predicate ::= IDENTIFIER PAREN_L obj_list PAREN_R */
#line 74 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy20 = new Predicate(yymsp[-3].minor.yy0, yymsp[-1].minor.yy18);   yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,4,&yymsp[0].minor);
}
#line 796 "as2transition/parser/lemon_parser.c"
        break;
      case 7: /* predicate ::= TILDE IDENTIFIER */
#line 76 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy20 = new Predicate(yymsp[0].minor.yy0, NULL, true);   yy_destructor(yypParser,6,&yymsp[-1].minor);
}
#line 802 "as2transition/parser/lemon_parser.c"
        break;
      case 8: /* predicate ::= TILDE IDENTIFIER PAREN_L obj_list PAREN_R */
#line 77 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy20 = new Predicate(yymsp[-3].minor.yy0, yymsp[-1].minor.yy18, true);   yy_destructor(yypParser,6,&yymsp[-4].minor);
  yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,4,&yymsp[0].minor);
}
#line 810 "as2transition/parser/lemon_parser.c"
        break;
      case 9: /* obj_list ::= object */
#line 79 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy18 = new Predicate::PredElement::ElementList(); yygotominor.yy18->push_back(yymsp[0].minor.yy2); }
#line 815 "as2transition/parser/lemon_parser.c"
        break;
      case 10: /* obj_list ::= obj_list COMMA object */
#line 80 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy18 = yymsp[-2].minor.yy18; yygotominor.yy18->push_back(yymsp[0].minor.yy2);   yy_destructor(yypParser,5,&yymsp[-1].minor);
}
#line 821 "as2transition/parser/lemon_parser.c"
        break;
      case 11: /* object ::= IDENTIFIER */
#line 82 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy2 = new PredElement(PredElement::Type::OBJECT, yymsp[0].minor.yy0); }
#line 826 "as2transition/parser/lemon_parser.c"
        break;
      case 12: /* object ::= IDENTIFIER PAREN_L obj_list PAREN_R */
#line 83 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy2 = new PredElement(PredElement::Type::OBJECT, yymsp[-3].minor.yy0, yymsp[-1].minor.yy18);   yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,4,&yymsp[0].minor);
}
#line 833 "as2transition/parser/lemon_parser.c"
        break;
      case 13: /* object ::= INTEGER */
#line 84 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy2 = new PredElement(PredElement::Type::INTEGER, yymsp[0].minor.yy0); }
#line 838 "as2transition/parser/lemon_parser.c"
        break;
      case 14: /* object ::= STRING_LITERAL */
#line 85 "as2transition/parser/lemon_parser.y"
{ yygotominor.yy2 = new PredElement(PredElement::Type::STRING_LITERAL, yymsp[0].minor.yy0); }
#line 843 "as2transition/parser/lemon_parser.c"
        break;
      default:
      /* (1) pred_list ::= */ yytestcase(yyruleno==1);
      /* (4) pred_list ::= pred_list error */ yytestcase(yyruleno==4);
        break;
  };
